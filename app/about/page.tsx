      ...
      <div className="about-container">
          ...
          <div className="about-features-grid">
            <div className="about-feature-card">
              <div className="about-feature-header">
                ...
                <h3 className="about-feature-title">Interactive Exploration</h3>
              </div>
            ...
            <div className="about-feature-card">
              ...
              <p className="about-feature-description">
                Dive deep into the stories behind famous landmarks, learn about
                local traditions, and discover the unique aspects that make each
                country special. Our content goes beyond surface-level
                information.
              </p>
            </div>
            ...
            <div className="about-feature-card">
              ...
              <p className="about-feature-description">
                Test your knowledge with interactive quizzes, explore historical
                timelines, and engage with educational games designed to make
            ...
            <div className="about-feature-card">
              ...
              <p className="about-feature-description">
                Our platform covers all 195 countries with detailed information
                about their geography, culture, history, and modern-day
        ...
        <div className="about-cta-section">
          ...
          <div className="about-cta-buttons">
            <Link href="/browse/countries" className="about-cta-button primary">
              <Globe size={20} />
              Explore Countries
            </Link>
