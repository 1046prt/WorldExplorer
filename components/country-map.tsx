...
export function CountryMap({ country }: CountryMapProps) {
  return (
    <Card className="p-6 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
      ...
      <div className="relative w-full h-64 bg-gradient-to-b from-green-100 to-green-200 dark:from-green-900 dark:to-green-800 rounded-lg overflow-hidden border">
        {/* Placeholder for country-specific SVG map */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <div className="text-4xl mb-2">🗾</div>
            <p className="text-gray-700 dark:text-gray-300 font-medium">{country.name} Map</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Interactive map with states and landmarks</p>
          </div>
        </div>
      </div>
