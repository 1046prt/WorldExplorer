...
// import { OptimizedImage } from "@/components/ui/optimized-image"; // Temporarily disabled
import type {
  Country,
  GeologicalFormation,
  WaterBody,
...
export function ComprehensiveCountryData({
  ...
  const categories = [
    ...
    { key: "geography", label: "Geography", icon: Mountain },
    ...
    { key: "culture", label: "Culture", icon: GraduationCap },
  ...
  return (
    <div className="comprehensive-container">
      ...
      {/* Chip Category Selector - Similar to Nature Explorer */}
      <div className="comprehensive-category-section">
        <div className="comprehensive-categories-grid">
          {categories.map((category) => {
            ...
            return (
              <button
                key={category.key}
                className={`comprehensive-category-btn ${
                  isActive ? "active" : ""
                }`}
      ...
      <div className="comprehensive-content-area">
        ...
        {/* Geography */}
        {selectedCategory === "geography" && country.geography && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
            ...
            <Card className="data-card">
              ...
              <CardContent className="card-content-compact">
                {country.geography.majorWaterBodies?.map((body: WaterBody) => (
                  <div key={body.name} className="water-body-item">
                    ...
                    {body.description && (
                      <p className="water-body-detail">{body.description}</p>
                    )}
                  </div>
                ))}
              </CardContent>
        ...
        {/* Heritage */}
        {selectedCategory === "heritage" && country.heritage && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
                ...
                {country.heritage.colonialHistory?.map(
                  (period: ColonialPeriod, index: number) => (
                    <div key={index} className="formation-item">
                      <div className="formation-header">
                        <span className="formation-name">{period.period}</span>
                      </div>
        ...
        {/* Politics */}
        {selectedCategory === "politics" && country.politics && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">Government</CardTitle>
              </CardHeader>
              <CardContent className="card-content-compact">
                <div className="data-row">
        ...
        {/* Economy */}
        {selectedCategory === "economy" && country.economy && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
            ...
            <Card className="data-card">
              ...
              <CardContent className="card-content-compact">
                <div className="badge-list">
                  {country.economy.majorIndustries?.map((industry: string) => (
        ...
        {/* Culture */}
        {selectedCategory === "culture" && country.culture && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
              ...
              <CardContent className="card-content-compact">
                <div className="data-section">
                  ...
                  <div className="badge-list">
                    {country.culture.officialLanguages?.map((lang: string) => (
                ...
                <div className="data-section">
                  ...
                  <div className="badge-list">
                    {country.culture.regionalLanguages?.map((lang: string) => (
                      <Badge key={lang} variant="secondary">
                        {lang}
                      </Badge>
                    ))}
                ...
                {country.culture.nationalFestivals?.map(
                  (festival: NationalFestival) => (
                    <div key={festival.name} className="formation-item">
                      <div className="formation-header">
                        <span className="formation-name">{festival.name}</span>
        ...
        {/* Education */}
        {selectedCategory === "education" && country.education && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
                ...
                {country.education.famousScientists?.map(
                  (scientist: Scientist) => (
                    <div key={scientist.name} className="formation-item">
                      <div className="formation-header">
                        <span className="formation-name">{scientist.name}</span>
                        <Badge variant="outline">{scientist.field}</Badge>
                      </div>
                      <p className="formation-desc">{scientist.achievement}</p>
                    </div>
                  )
                )}
              </CardContent>
        ...
        {/* Demographics */}
        {selectedCategory === "demographics" && country.demographics && (
          <div className="data-grid">
            <Card className="data-card">
              <CardHeader className="card-header-compact">
                <CardTitle className="card-title-compact">
